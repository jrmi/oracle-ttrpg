...
export const oracle = (type) => {
  ...
  const mainAction = [
    ...
    { item: i18next.t('strong_yes'), weight: 4, addition: actionStrongYes },
    ...
    { item: i18next.t('strong_no'), weight: 4, addition: payPrice },
  ];
  ...
  const mainQuestion = [
    ...
    { item: i18next.t('strong_yes'), weight: 2, addition: questionStrongYes },
    { item: i18next.t('weak_yes'), weight: 8, addition: questionWeakYes },
    // { item: i18next.t('no_but'), weight: 4, addition: oracleResultsPlus },
    { item: i18next.t('strong_no'), weight: 2, addition: questionStrongNo },
  ];
